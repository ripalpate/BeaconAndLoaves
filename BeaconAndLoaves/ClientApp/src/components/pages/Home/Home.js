    ...
    return (
      <div className="Home mx-auto">
        <div className="card-columns homeWrapper mt-5">
          ...
          <div className="card mt-3 border-dark animated zoomIn" id='likedProperties' onClick={this.changeView}>
            <div className="card-body home text-center">
          ...
          <div className="card mt-3 border-dark animated zoomIn" id='properties' onClick={this.changeView}>
            <div className="card-body home text-center">
          ...
          <div className="card mt-3 border-dark animated zoomIn" id='addProperty' onClick={this.togglePropertyModal}>
            <div className="card-body home text-center">
