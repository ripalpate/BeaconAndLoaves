...
class Profile extends React.Component {
  ...
  formFieldStringState = (name, e) => {
    const tempUser = { ...this.props.editedUser };
    ...
    const makeHistoryButtons = () => {
      ...
      return (
        <div>
            ...
            <button id='profile-delete' type="button" className="bttn-pill delete-btn ml-2 mr-2" onClick={this.toggleModal} title="Delete Profile">
              <i className="profile-delete-btn fas fa-trash fa-1x"></i>
            </button>
        </div>
      );
